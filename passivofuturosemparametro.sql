...
WITH 
PARAMETRO AS (
    SELECT CONVERT(DATETIME, '04/12/2025', 103) AS DATA_PARAM
),
...
ISNULL(DECTERSALARIO, 0) * 0.08 AS DECIMOTERCEIROFGTS,
((ISNULL(SALBASE, 0)/30) * ISNULL(DIAS_SALDO_SALARIO, 0)) * 0.08 AS FGTS_MES,
(ISNULL(SALDO_FGTS,0) + ISNULL(SALDO_SALARIO* 0.08,0) + ISNULL(FGTS,0))*0.4 AS MULTA_FGTS_AJUSTADO,--(ISNULL(SALDO_FGTS, 0) + ((ISNULL(SALBASE, 0)/30) * ISNULL(DIAS_SALDO_SALARIO, 0)) * 0.08 + ISNULL(DECTERSALARIO, 0) * 0.08 + ISNULL(FGTS_DECTERC_API, 0) + ISNULL(FGTS_AVISO_IND, 0)) * 0.4 
...
(ISNULL(FERIAS_PROPORCIONAIS, 0) + ISNULL(MEDIA_FERIAS_PROPORCIONAIS, 0) + ISNULL(TERCO_FERIAS_PROPORCIONAIS, 0) + 
 ...
 ISNULL(TERCO_FERIAS_PROP_API, 0) + (ISNULL(FERIAS_PROPORCIONAIS, 0) + ISNULL(MEDIA_FERIAS_PROPORCIONAIS, 0))) AS TOTAL_VERBAS_RESCISORIAS,
...
(((ISNULL(SALBASE, 0)/30) * ISNULL(DIAS_SALDO_SALARIO, 0)) * 0.08 + ISNULL(FGTS_AVISO_IND, 0) + ISNULL(FGTS_DECTERC_API, 0) + 
 ...
 ((ISNULL(SALBASE, 0)/30) * (ISNULL(DIAS_SALDO_SALARIO, 0)) * 0.08)) + FGTS AS  TOTAL_FGTS,
...
(ISNULL(FERIAS_PROPORCIONAIS, 0) + ISNULL(MEDIA_FERIAS_PROPORCIONAIS, 0) + ISNULL(TERCO_FERIAS_PROPORCIONAIS, 0) + 
 ...
 ISNULL(MEDIA_DECTERCSALARIO, 0) + ISNULL(AVISO_PREVIO_INDENIZADO, 0) + ISNULL(DECTER_API, 0) + 
 ISNULL(MEDIA_DECTER_API, 0) + ISNULL(FERIAS_PROP_API, 0) + ISNULL(MEDIA_FERIAS_API, 0) + 
 ISNULL(TERCO_FERIAS_PROP_API, 0) + (ISNULL(FERIAS_PROPORCIONAIS, 0) + ISNULL(MEDIA_FERIAS_PROPORCIONAIS, 0))) +
(((ISNULL(SALBASE, 0)/30) * ISNULL(DIAS_SALDO_SALARIO, 0)) * 0.08 + ISNULL(FGTS_AVISO_IND, 0) + ISNULL(FGTS_DECTERC_API, 0) + 
 (ISNULL(SALDO_FGTS, 0) + ((ISNULL(SALBASE, 0)/30) * ISNULL(DIAS_SALDO_SALARIO, 0)) * 0.08 + ISNULL(DECTERSALARIO, 0) * 0.08 + ISNULL(FGTS_DECTERC_API, 0) + ISNULL(FGTS_AVISO_IND, 0)) * 0.4 + 
...
ISNULL(DECTERSALARIO, 0) * 0.08 AS DECIMOTERCEIROFGTS,
((ISNULL(SALBASE, 0)/30) * ISNULL(DIAS_SALDO_SALARIO, 0)) * 0.08 AS FGTS_MES,
(ISNULL(SALDO_FGTS,0) + ISNULL(SALDO_SALARIO* 0.08,0) + ISNULL(FGTS,0))*0.4 AS MULTA_FGTS_AJUSTADO,
