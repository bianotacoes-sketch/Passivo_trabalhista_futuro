...
ISNULL(FERIAS_PROPORCIONAIS, 0) + ISNULL(MEDIA_FERIAS_PROPORCIONAIS, 0) AS UM_TERCO_FERIAS_PROPROCIONAIS,
ISNULL(DECTERSALARIO, 0) * 0.08 AS DECIMOTERCEIROFGTS,
((ISNULL(SALBASE, 0)/30) * ISNULL(DIAS_SALDO_SALARIO, 0)) * 0.08 AS FGTS_MES,
(ISNULL(SALDO_FGTS, 0) + ((ISNULL(SALBASE, 0)/30) * ISNULL(DIAS_SALDO_SALARIO, 0)) * 0.08 + ISNULL(DECTERSALARIO, 0) * 0.08 + ISNULL(FGTS_DECTERC_API, 0) + ISNULL(FGTS_AVISO_IND, 0)) * 0.4 AS MULTA_FGTS_AJUSTADO,
...
(((ISNULL(SALBASE, 0)/30) * ISNULL(DIAS_SALDO_SALARIO, 0)) * 0.08 + ISNULL(FGTS_AVISO_IND, 0) + ISNULL(FGTS_DECTERC_API, 0) + 
 ...
 (ISNULL(DECTERSALARIO, 0) * 0.08)) AS TOTAL_FGTS,
